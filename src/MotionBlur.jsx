...
// from: https://docs.pmnd.rs/react-postprocessing/effects/custom-effects

const fragmentShader = `
uniform float strength;
uniform sampler2D inputBuffer; // Add this line
...
class MotionBlurImpl extends Effect {
    constructor() {
        super('MotionBlur', fragmentShader, {
            uniforms: new Map([
                ...
                ['inputBuffer', new Uniform(null)], // Add this line
            ]),
        });
    }
    ...
    update(renderer, inputBuffer, deltaTime) {
        ...
        this.uniforms.get('inputBuffer').value = inputBuffer.texture; // Add this line
    }
}
